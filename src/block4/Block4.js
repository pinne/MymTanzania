            ...
            <div>
                <section id={instafeedTarget} className='block block4'>
                    <Instafeed
                        ...
                        template='<a class="instafeedTarget__link" href="{{link}}" target="_blank" id="{{id}}"><img class="instafeedTarget__image" src="{{image}}" /><div class="instafeedTarget__caption">{{model.short_caption}}</div></a>'
                        userId='5908742622'
